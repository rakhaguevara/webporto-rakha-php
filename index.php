...
<html lang="en">
  ...
  ORDER BY project.id_project DESC
  ";
          ...
          <div class="swiper portfolio-swiper">
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <div class="card">
                  <div class="card-body">
                    <img src="./src/assets/images/IMG_8291.JPG" alt="" class="card-img-top rounded mb-3" />
              ...
              <div class="swiper-slide">
                <div class="card">
                  <div class="card-body">
                    <img src="./src/assets/images/IMG_8624.JPG" alt="" class="card-img-top rounded mb-3" />
                    <h6 class="fw-semibold">COMING SOON</h6>
                    <p class="text-secondary fs-7">COMING SOON</p>
                    <a href="#" class="text-orange"> Coming soon</a>
                  </div>
              ...
              <div class="swiper-slide">
                <div class="card">
                  <div class="card-body">
                    <img src="./src/assets/images/IMG_8623.JPG" alt="" class="card-img-top rounded mb-3" />
                    <h6 class="fw-semibold">COMING SOON</h6>
                    <p class="text-secondary fs-7">COMING SOON</p>
                    <a href="#" class="text-orange"> Coming soon</a>
                  </div>
              ...
              <div class="swiper-slide">
                <div class="card">
                  <div class="card-body">
                    <img src="./src/assets/images/news-4.png" alt="" class="card-img-top rounded mb-3" />
                    <h6 class="fw-semibold">COMING SOON</h6>
                    <p class="text-secondary fs-7">COMING SOON</p>
                    <a href="#" class="text-orange"> Coming soon</a>
                  </div>
              ...
              <div class="swiper-slide">
                <div class="card">
                  <div class="card-body">
                    <img src="./src/assets/images/news-5.png" alt="" class="card-img-top rounded mb-3" />
                    <h6 class="fw-semibold">COMING SOON</h6>
                    <p class="text-secondary fs-7">COMING SOON</p>
                    <a href="#" class="text-orange"> Coming soon</a>
                  </div>
